...
write.table(rank_global_result_sort,paste0(output_dir,'/',disease_name,'_permutation_result.txt'),quote = F,row.names=F,col.names=T)

write.table(rank_global_result_sort_no_seed,paste0(output_dir,'/',disease_name,'_permutation_no_seed_result.txt'),quote = F,row.names=F,col.names=T)
