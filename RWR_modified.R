...
for (disease_name in disease_name_list){
  ...
  write.table(rank_global, paste0('RWR_Zscore_norm_modification/',disease_name,'_RWR_M_method_3_layer_PPI_KEGG_Coexpression_gene_1e-15.txt'),quote = F,row.names=F,col.names=T)
  ...
  write.table(rank_global_NoSeeds,paste0('RWR_Zscore_norm_modification/',disease_name,'_No_Seeds_RWR_M_method_3_layer_PPI_KEGG_Coexpression_gene_1e-15.txt'),quote = F,row.names=F,col.names=T)
